...
var MonthView = _react2.default.createClass({
  ...
  getActiveWeek: function getActiveWeek(weeks) {
    var activeWeekIndex = 0;
    weeks.forEach(function (week, index) {
      week.forEach(function (day) {
        if (_dates3.default.eq(day, new Date(), 'day')) activeWeekIndex = index;
      });
    });
  ...
  render: function render() {
    ...
    var activeWeek = this.getActiveWeek(weeks);
    ...
    return _dates3.default.range(first, last, 'day').map(function (day, idx) {
      return _react2.default.createElement(
        'div',
        {
          key: 'header_' + idx,
          style: (0, _eventLevels2.segStyle)(1, 7),
          className: (0, _classnames2.default)('rbc-header', {
            'rbc-now': _dates3.default.eq(day, new Date(), 'day'),
            'rbc-current': _dates3.default.eq(day, _this7.props.date, 'day')
          })
        },
    ...
    return _react2.default.createElement(
      _Overlay2.default,
      {
        ...
        onHide: function onHide() {
          _this9.props.onHideMore(overlay.date, overlay.events, overlay.position);
          _this9.setState({ overlay: null });
        }
      },
  ...
  _showMore: function _showMore(segments, date, weekIdx, slot) {
    ...
    var position = void 0;
    if (this.props.popup) {
      position = (0, _position2.default)(cell, (0, _reactDom.findDOMNode)(this));
    ...
    (0, _helpers.notify)(this.props.onShowMore, [date, events, position]);
  },
