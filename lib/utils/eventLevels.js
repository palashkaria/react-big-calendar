...
function sortEvents(evtA, evtB, _ref3) {
  ...
  if (allDaySortKey) {
    if ((0, _accessors.accessor)(evtA, allDaySortKey) > (0, _accessors.accessor)(evtB, allDaySortKey)) {
      return 1;
    } else if ((0, _accessors.accessor)(evtA, allDaySortKey) < (0, _accessors.accessor)(evtB, allDaySortKey)) {
      return -1;
    } else {
      return 0;
    }
